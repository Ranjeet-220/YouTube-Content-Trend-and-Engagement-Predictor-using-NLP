...
import { AlertCircle, TrendingUp, Search, MessageSquare, Loader2, Sparkles } from 'lucide-react';
            ...
            {results ? (
              ...
              <div className="h-full min-h-[400px] glass-panel rounded-2xl flex flex-col items-center justify-center p-8 text-center border-dashed border-2 border-slate-700/50">
                ...
                <p className="text-slate-500 max-w-sm">
                  Enter your video metadata on the left and click 'Predict Engagement' to see AI-powered insights and predictions.
                </p>
              </div>
            )}
          </div>
